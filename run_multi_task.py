...
# Taken from https://github.com/AsaCooperStickland/Bert-n-Pals
# MODIFICATIONS DONE: Adapted for goemotion and twitter sentiment data.
# Original code was written for glue tasks and hence data processing part were modified.
# Some minor additional modifications.
#########################################
...
class GoemotionProcessor(DataProcessor):
...
class GoemotionProcessor_ekman(DataProcessor):
    """Processor for the GoemotionProcessor data set."""
